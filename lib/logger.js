 ...
 * @property {(mergingObject: object | string, message?: string) => void} info
 * @property {(mergingObject: object | string, message?: string) => void} warn
 * @property {(mergingObject: object | string, message?: string) => void} error
 */
